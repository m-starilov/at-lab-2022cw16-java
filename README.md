...
```
cd existing_repo
git remote add origin https://git.epam.com/Aliaksandr_Harmaza/at-lab-2022cw16-java.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.epam.com/Aliaksandr_Harmaza/at-lab-2022cw16-java/-/settings/integrations)
